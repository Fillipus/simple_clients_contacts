        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="btn-group btn-group-toggle mb-4" data-toggle="buttons">
                    <label class="btn btn-outline-primary active" id="generalTabButton">
                        <input type="radio" name="tabs" checked onclick="switchTab('general')" /> General
                    </label>
                    <label class="btn btn-outline-primary" id="linkingTabButton">
                ...
                <div id="linkingTab" class="tab-content d-none">
